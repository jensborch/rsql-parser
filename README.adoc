...
CAUTION: *This is a fork of the original https://github.com/jirutka/rsql-parser[RSQL parser] with added support for nested queries. If your project doesn't require this feature, it's advisable to use https://github.com/nstdio/rsql-parser[this maintained fork] instead.*
